...
# --- Tool Definitions ---
WORKER_MODEL = "ollama/gemma3:12b"      # Model for executing tasks gemma3:12b
OLLAMA_BASE_URL = "http://localhost:11434"

try:
    worker_llm = LLM(model=WORKER_MODEL, api_base=OLLAMA_BASE_URL,timeout=1200, temperature=0.1)
...
if __name__ == "__main__":
    # Example user request and supporting data
    user_request = (
    ...
    # create_crew_plan(user_request, supporting_data)
